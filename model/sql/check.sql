...
END IF;
select COUNT(*) from INFORMATION_SCHEMA.COLUMNS 
where table_name = 'user' and (column_name = 'user_id' OR column_name = 'user_prn_status' OR column_name = 'user_telegram_id' OR column_name = 'user_telegram_name' OR column_name = 'user_messenger_name' OR column_name = 'user_messenger_id' OR column_name = 'user_status_id' OR column_name = 'user_city' OR column_name = 'user_country' OR column_name = 'user_mail_address') into test;
